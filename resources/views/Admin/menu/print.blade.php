<x-app>
    <section class="p-10">
        ...
        <div class="pt-3">
            <h1 class="text-3xl ">Laporan Menu RestoKu</h1>
        ...
        <form class="py-2 flex gap-3 items-center">
            <div>
                ...
                <select name="pilihan" id="" class="p-2 border">
                    <option value="1" {{ $request->bulan == "1" ? 'selected' : '' }}>Harian</option>
                    <option value="2" {{ $request->bulan == "2" ? 'selected' : '' }}>Mingguan</option>
                    <option value="3" {{ $request->bulan == "3" ? 'selected' : '' }}>Bulanan</option>
                </select>
            </div>
            <div>
                <h1>Hari</h1>
