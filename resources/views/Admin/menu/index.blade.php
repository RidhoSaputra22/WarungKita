<x-admin-app>
    <section>
        <div class="pb-3">
            <a href="{{ route('menu.create') }}" class="px-3 py-1 border rounded shadow-xl">Tambah Data</a>
            <a href="/print/menu" class="px-3 py-1 border rounded shadow-xl">Print Data</a>
        </div>
