        ...
        <div class="p-5 lg:px-32 lg:py-10 h-full">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-none lg:flex border-b-4 border-red-900 text-black ">
                <a href="/driver/pending/"
                    class="w-full flex justify-center items-center px-6 py-2 text-sm text-black lg:w-max">Orderan
                    Baru</a>
                <a href="/driver/selesai/"
                    class="w-full flex justify-center items-center px-6 py-2 text-sm  bg-red-900 text-white hover:text-white hover:bg-red-900 lg:w-max">Orderan
                    Selesai </a>
            ...
            <div class="py-3 flex flex-col gap-3 lg:flex-row h-full ">
                ...
                @if ($datas->count() > 0)
                    <div class="w-full lg:w-96 lg:px-5 h-full">
                        ...
                        <div class="pt-3 px-3 ">
                            <div class="print flex flex-col gap-3 w-full text-lg ">
                                <div class="text-lg">
                                    <div>Nama</div>
                                    <div class="text-sm">
                                ...
                                @if ($datas->isNotEmpty())
                                    <div
                                        class="flex h-full flex-col-reverse pt-5 ">

                                        <button onclick="window.print()" class="px-4 py-2 bg-red-900 text-white w-full ">
