                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex flex-col md:flex-row justify-between mb-4">
                        ...
                        <div class="mt-2 md:mt-0">
                            <span
                                class="px-3 py-1 rounded-full text-sm bg-green-100 text-green-800">{{ $data['status_222339'] }}</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 flex justify-end gap-3">
                        <a class="px-4 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50"
                            href="/detail/{{ $data['nama_222339'] }}">Detail</a>
                        @if ($data['status_222339'] == 'selesai')
                            <a class="px-4 py-2 text-sm bg-red-900 text-white rounded-lg hover:bg-red-900"
                                href="/AddToCart/{{ $data['nama_222339'] }}">Beli Lagi</a>
                        @else
                            <a class="px-4 py-2 text-sm bg-red-900 text-white rounded-lg hover:bg-red-900"
