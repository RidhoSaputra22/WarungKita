...
class MenuController
{
    ...
    public function menu(Request $request)
    {
        ...
        if($request->has('kategori')){
            $datas = Menu::where('222118_id_kategori', $request->kategori)->get();
        }
        if($request->has('search')){
            $datas = Menu::where('222118_nama', 'like' , '%'.$request->search.'%')->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        Menu::create([
            '222118_nama' => $request['nama'],
            '222118_harga' => $request['harga'],
            '222118_stok' => $request['stok'],
            '222118_id_kategori' => $request['kategori'],
            '222118_foto' => 'image/menu/' . $fileName,
